...
public class Fenster {
	...
	//Membervariablen für ActionListener
	...
	/**
	 *public void setCenterTextPaneFormatted
	 *--------------------------------------
	 *@param: text (String)
	 *@param: highlighted (boolean)
	 *@param: append (boolean)
	 *--------------------------------------
	 * Formatiertes Einfuegen in die TextPane
	 */
    ...
    /**
     * public void showOptionFeiertage
     * -----------------------------------------
     * @param: feiertage (String)
     * -----------------------------------------
     * Messagedialog-Fenster fuer die Feiertage wird erstellt 
     */
     ...
     * -----------------------------------------
     * Messagedialog-Fenster fuer die Infos zur Autorin wird erstellt
     */
    public void showOptionPaneMenuAutorin() {
     ...
     * -----------------------------------------
     * Messagedialog-Fenster fuer die Hile-Option im Menu 
     */
    public void showOptionPaneMenuHilfe() {
    	JOptionPane.showMessageDialog(frame, "Der Kalender ist intuitiv benutzbar!");
    }
     ...
     * @param: mode (int)
     * -----------------------------------------
     * Fuer MessageDialog Look and Feel und die Erstellung der Designs Window, Metal, Motif
     */
     ...
     * @return: int
     * ----------------------------------------
     * Erstellt die Option, um den "von"-Monat im Jahresplaner zu setzen
     */
    public int showJahresplanerVon() {
    	...
    	// erfolgt, wenn Nutzer "cancel" klickt
    	if( null == ret) {
    		return -1;
    	}
     ...
     * @return: int
     * ----------------------------------------
     * Erstellt die Option, um den "bis"-Monat im Jahresplaner zu setzen
     */
    public int showJahresplanerBis() {
    ...
    /**
     * public void showJahresplaner
     * ----------------------------------------
     * @rparam: jahresplanerText (String)
     * ----------------------------------------
     * Erstellt ein separates Fenster und befuellt es mit
     * dem Jahresplaner
     */
    public void showJahresplaner( String jahresplanerText) {

    	// sicherstellen, dass es immer nur ein Fenster gibt!
		...
		// Schrift muss Courier sein, damit Format erhalten bleibt
     ...
     * ----------------------------------------
     * Speichert den Jahresplaner im RTF-Format.
     */
    public void saveJahresplaner() {
     ...
     * -------------------------------------------------
     * Oeffnet Datei im Center Panel in TextPane
     */
    public void openFileCenterPane() {
     ...
     * -------------------------------------------------
     * Speichert die Ausgabe auf der TextPane (center) in RTF-Dateiformat.
     */
    public void saveCenterPane() {
     ...
     * ----------------------------------------------------------------------
     * Setzt das Bild zum passenden Monat im linken Panel.
     */
    public void setImageMonth() {
     ...
     * ---------------------------------------------------------------------
     * Beendet das Program im Menupunkt Close.
     */
    public void terminate() {
