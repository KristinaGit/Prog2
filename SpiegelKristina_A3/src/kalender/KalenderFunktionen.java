 ...
 * Schaltjahrregel, Tagesnummer, Julianisches Datum, Berechnung des Ostersonntags.
 * 
 * Diese Algorithmen sind zusammengetragen aus verschiedenen Quellen.
 * 
 * Bitte ver�ndern Sie diese Datei nicht! 
 * Falls Sie zus�tzliche Funktionen ben�tigen, legen Sie eine eigene java-Datei an!
 * 
 * @author bannert
 */
 ...
 * gibt zu einem Julian Date den gregorianisches Kalendertag zur�ck
 * 
 * Der gregorianische Kalender gilt nur f�r jd >= 2299161 (entspicht dem Jahr 1582 greg./ Tag? Monat?)
 ...
 */
 public String kalenderDatumFuerJD( long jd ){
 	 ...
 	 // Der gregorianische Kalender gilt nur f�r JD gr��er/gleich 2299161 (1582 greg.)
 	 // davor gilt der Julianische Kalender
 	 if( jd >= 2299161){
