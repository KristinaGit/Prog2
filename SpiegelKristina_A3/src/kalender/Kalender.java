...
public class Kalender implements IKalender {
	 ...
	 */
	  ...
	  * --------------------------------------
	  * getter-Funktion für calFormatSelection, Umwandlung in boolean um in der gui Mo/So zu aendern
	  */
	 public boolean getFormatSelection(){
		 if(0 == calFormatSelection){
			 return false;
		}
	 ...
	 /*
	  * public boolean setFormatSelection()
	  * ------------------------------------------
	  * setter-Funktion aendert calFormatSelection
	  */
	 public void setFormatSelection(boolean val){
		 if(val == true){
	 ...
	 /*
	  * public void toggleFormatSelection()
	  * -----------------------------------------
	  * Hilfsmethode um calFormatiSelection zu aendern (switch)
	  */
	 public void toggleFormatSelection() {
	 	if( 0 == calFormatSelection) {
			calFormatSelection = 1;
